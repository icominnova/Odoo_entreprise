    ...
    def _planning_slot_vals_list_per_sol(self):
        ...
        for sol, vals_list in vals_list_per_sol.items():
            ...
            for resource in resource_leaves:
                ...
                elif resource.calendar_id:
                    removed_calendar_ids += resource.calendar_id
                # if no calendar_id then leave applies to all resources.
                else:
                    all_resource_leave = True
                    break
            available_resources = available_resources.filtered(lambda r: r not in unavailable_resources and r.calendar_id not in removed_calendar_ids)
